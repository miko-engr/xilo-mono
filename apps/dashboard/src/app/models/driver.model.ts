...
export class Driver {
  constructor(
    ...
    public yearLicensed?: string,
    public numberOfAccidents?: string,
    public numberOfViolations?: string,
    public hasAdditionalLicense?: string,
    public additionalLicenseType?: string,
    public additionalLicenseNumber?: string,
    public fullName?: string,
    public ssnuHash?: string,
